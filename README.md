...
<br><br>4. Pandas library in Python - Our initial upload process involved using the Pandas library built in function to read data.  It was working incredibly quickly but we quickly encountered an issue with our site hanging and not being able to load.  We worked on other solutions to try to resolve this issue and eventually realized the Pandas function/dependency was the cause of the hang.  The debuging process took us over 24 hours and it was a very important lesson to keep track of what libraries you are importing and making sure they aren't bogging down your system.
